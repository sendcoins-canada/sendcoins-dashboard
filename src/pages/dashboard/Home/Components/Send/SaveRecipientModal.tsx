...
const SaveRecipientModal: React.FC<SaveRecipientModalProps> = ({
  ...
  return (
    <Modal open={open} onOpenChange={onOpenChange} className="max-w-md bg-[#F5F5F5]" showCloseIcon>
      <h2 className="text-lg font-semibold text-center mb-4">Save this recipient</h2>
      ...
      <div className="space-y-4 bg-white p-4 rounded-2xl">
        ...
        <div className="bg-[#F9FAFB] rounded-lg p-3 text-sm space-y-2">
